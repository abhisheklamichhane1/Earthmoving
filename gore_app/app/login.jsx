...
export default function LoginScreen() {
  ...
  const loginMutation = useMutation({
    ...
    onSuccess: async (loginData) => {
      ...
      try {
        const { siteID, userName, userID, displayName, siteName, timeEntryType } = loginData;

        await storeData('userData', JSON.stringify({ siteID, userName, userID, displayName, siteName, timeEntryType}));
        setUserData({siteID, userName, userID, displayName, siteName, timeEntryType});
